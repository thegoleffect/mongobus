(function() {
  ...
  Mongobus = (function() {
    ...
    Mongobus.prototype.create = function(collectionName, opts, callback) {
      ...
      return this.collectionExists(collectionName, function(err, exists) {
    ...
    Mongobus.prototype.drop = function(collectionName, callback) {
      var _this = this;
      return this.collectionExists(collectionName, function(err, exists) {
        if (!exists) return callback(null, true);
        return _this.db.connection.collection(collectionName).drop(callback);
      });
    };
    ...
    Mongobus.prototype.collectionExists = function(collectionName, callback) {
